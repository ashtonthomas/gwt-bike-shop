...
/**
 * This class should represent every possible variable that 
 * host pages may expect.
 * 
 * This is helpful as it may be hard to determin all the 
 * variables expected and used by the different JSP partials.
 * This class is the only way to programmatically account for 
 * all the details
 *  
 * @author ashton
 *
